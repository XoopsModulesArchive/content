...
function FileUpload($resourceType, $currentFolder)
{
    ...
    if (isset($_FILES['NewFile']) && null !== $_FILES['NewFile']['tmp_name']) {
        ...
        if ((0 == count($arAllowed) || in_array($sExtension, $arAllowed, true)) && (0 == count($arDenied) || !in_array($sExtension, $arDenied, true))) {
            $iCounter = 0;
