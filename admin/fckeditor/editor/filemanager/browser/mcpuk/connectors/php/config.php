...
$fckphp_config['prot'] .= ((isset($_SERVER['HTTPS']) && 'on' == $_SERVER['HTTPS']) ? 's' : '');
$fckphp_config['prot'] .= '://';
/*==============================================================================*/
...
$fckphp_config['prot'] . $_SERVER['SERVER_NAME'];
/*==============================================================================*/

/*------------------------------------------------------------------------------*/
/* Path to user files relative to the document root (no trailing slash)		*/
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = '/uploads';
/*==============================================================================*/
...
//File Area
$fckphp_config['ResourceAreas']['File'] = [
    //Files(identified by extension) that may be uploaded to this area

'AllowedExtensions' => ['zip', 'doc', 'xls', 'pdf', 'rtf', 'csv', 'jpg', 'gif', 'jpeg', 'png', 'avi', 'mpg', 'mpeg', 'swf', 'fla'],
...
//Image area
$fckphp_config['ResourceAreas']['Image'] = [
    'AllowedExtensions' => ['jpg', 'gif', 'jpeg', 'png', 'tiff', 'tif'],
'AllowedMIME' => [],
'MaxSize' => 1024,
'DiskQuota' => 5,
'HideFolders' => ["^\."],
...
/* $_GET */
$fckphp_config['Debug_GET'] = false;
/* $_POST */
$fckphp_config['Debug_POST'] = false;
/* $_SERVER */
$fckphp_config['Debug_SERVER'] = false;
/* $_SESSIONS */
$fckphp_config['Debug_SESSIONS'] = false;
...
/*------------------------------------------------------------------------------*/
$fckphp_config['ResourceTypes'] = ['File', 'Image'];
