    ...
    <div id="divLinkTypeUrl">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0" dir="ltr">
            <tr>
                <td valign="bottom">
                    Local Pages<br>
                    <select name="cmbLocalFileList" id="cmbLocalFileList" onchange="SetURLtoLocal();">
                        ...
                        foreach ($allMenuItems as $ct_item) {
                            ...
                            echo 'value="/modules/content/index.php?id=' . $ct_item['storyid'] . '">' . str_repeat('&nbsp;&nbsp;', ($ct_item['depth'] + 1)) . str_repeat('-', ($ct_item['depth'])) . $ct_item['title'] . '</option>';
                        }

                        ?>
                    </select></td>
                <td valign="bottom" width="100%">&nbsp;&nbsp;OR <span id="divBrowseServer"><input type="button" value="Browse Server" fckLang="DlgBtnBrowseServer" onclick="BrowseServer();"></span></td>
            </tr>
        </table>
        <br>
