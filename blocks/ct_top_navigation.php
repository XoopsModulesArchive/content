...
function content_block_top_nav()
{
    ...
    $result = $xoopsDB->query('SELECT link, storyid, blockid, title, visible, parent_id, address, newwindow FROM ' . $xoopsDB->prefix('content') . " WHERE visible='1' and parent_id = 0 ORDER BY blockid");
